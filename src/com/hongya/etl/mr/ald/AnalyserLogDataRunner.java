...
//            Path inputPath = new Path("/flume/" + TimeUtil.parseLong2String(TimeUtil.parseString2Long(date), "yyyy-MM-dd"));
            Path inputPath = new Path("file:///Users/dengziming/opt/data/hongya/taobaopayment/");
